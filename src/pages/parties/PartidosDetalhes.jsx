...
const PartidosDetalhes = (props) => {
	...
	return (
		<>
			<Container>
				<Button className="btn btn-light" variant="light" onClick={() => props.history.goBack()}>
					{' '}
					<BsArrowLeft /> Voltar
				</Button>
				{partidos.status && (
					<>
						<h1 style={{ paddingTop: '15px' }}>
							{partidos.nome} ({partidos.sigla}){' '}
							<Badge pill bg="success" style={{ fontSize: '18px', verticalAlign: '35%' }}>
								{' '}
								{partidos.status.situacao}
							</Badge>
						</h1>
						<hr />
